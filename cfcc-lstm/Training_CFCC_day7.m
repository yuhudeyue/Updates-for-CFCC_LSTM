function Training_CFCC_day7(day1,day2,location1,location2,location3,location4)
%location1//end line
...
for i=location3:location1
    for j=location4:location2
        ...
        if l==0
            Training_1_day7( location1,location2,location3,location4,testdata(location3-2:location3+2,location4-2:location4+2,1:day2),day-26);
        end
    end
end
weight_global = Training_2_day7( location1,location2,location3,location4,testdata(:,:,1:day2),day-26);
