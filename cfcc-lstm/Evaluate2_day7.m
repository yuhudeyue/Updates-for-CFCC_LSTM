function predict2=Evaluate2_day7(date_1,date_2,date_3,date_4,testdata,day)
...
%                         train_data(ij+25*num-25,m,n,i-day+1)=t;
%                         ij=ij+1;
%                     end
%                 end
%             end
%             train_data(1:25*7,m,n,i-day+1) = train_data(1:25*7,m,n,i-day+1)...
%                 /ma;  %归一�?
%         end
%     end
% end
...
predict2=zeros(7,date_3,date_4);
    load(['weight_6_7_ming' '.mat']);
...
d=1;
    ...
    filename1 = ['predict2_7_',num2str(date_3),'_',num2str(date_1),'_',num2str(date_4),'_',num2str(date_2)];
