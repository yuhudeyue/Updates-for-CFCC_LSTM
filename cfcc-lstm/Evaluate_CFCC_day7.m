function Evaluate_CFCC_day7(location1,location2,location3,location4)
%location1//end line
...
for i=location3:location1
    for j=location4:location2
        ...
        if l==0
            out = test_lstm_day7(testdata(location1-2:location1+2,location2-2:location2+2,:),i,j,day-26,data_num);
        end
    end
end
predict2=Evaluate2_day7(location1,location2,location3,location4,testdata,day-7);
[A,mse] = Evaluate20(location1,location2,location3,location4,testdata,predict2,out,day1,day2);
