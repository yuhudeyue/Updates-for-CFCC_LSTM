function Training_1_day30(date_1,date_2,date_3,date_4,testdata,day)
...
M=5;
N=5;
[train_data,test_data]=data_process_day30(day,testdata);
...
if (exist(['weight_30_' num2str(d1) '_' num2str(d2) '.mat'],'file') ~= 0)
        [bias_input_gate,...
            bias_forget_gate,...
            bias_output_gate,...
            weight_input_x,...
            ...
            weight_outputgate_c,...
            weight_preh_h,...
            h_state] = load_weight(['weight_30_' num2str(d1) '_' num2str(d2) '.mat']);
else
    [bias_input_gate,...
        bias_forget_gate,...
        bias_output_gate,...
...
out=zeros(output_num,group_x_num,group_y_num,1);
out_final=zeros(output_num,group_x_num,group_y_num,1);
output_final=zeros(output_num,group_x_num,group_y_num,1);
...
for group_x = 3:group_x_num-2
    for group_y = 3:group_y_num-2
        ...
        save_weight2_30(final_bias_input_gate,...
