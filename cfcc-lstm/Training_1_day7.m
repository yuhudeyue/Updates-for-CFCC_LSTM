function Training_1_day7(date_1,date_2,date_3,date_4,testdata,day)

testdata=double(int16(testdata));

M=5;
N=5;
[train_data,test_data]=data_process_day7(day,testdata);
...
if (exist(['weight_7_' num2str(d1) '_' num2str(d2) '.mat'],'file') ~= 0)
        [bias_input_gate,...
            bias_forget_gate,...
            bias_output_gate,...
            weight_input_x,...
            ...
            weight_preh_h,...
            h_state,...
            cell_state] = load_weight(['weight_7_' num2str(d1) '_' num2str(d2) '.mat']);
else
    [bias_input_gate,...
        bias_forget_gate,...
        bias_output_gate,...
...
for group_x = 3:group_x_num-2
    for group_y = 3:group_y_num-2
        ...
        save_weight2_7(final_bias_input_gate,...
